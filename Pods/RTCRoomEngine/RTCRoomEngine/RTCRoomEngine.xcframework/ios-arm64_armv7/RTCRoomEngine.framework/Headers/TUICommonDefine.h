...
typedef NS_ENUM(NSInteger, TUIError) {
    ...
    /// 当前房间需要密码才能进入。
    TUIErrorNeedPassword = -2109,

    /// 进房密码错误。
    TUIErrorWrongPassword = -2110,

    /// 房间成员已满。
    TUIErrorRoomUserFull = -2111,
    ...
    /// 信令请求冲突。
    TUIErrorRequestIdConflict = -2313,
    ...
    /// 不支持连麦。
    TUIErrorSeatNotSupportLinkMic = -2347,
    ...
    /// 当前房间已连线。
    TUIErrorRoomAlreadyConnected = -3001,

    /// 当前房间与其他房间连线中。
    TUIErrorRoomConnectedInOther = -3002,

    /// 当前房间连线超出最大数量限制。
    TUIErrorMaxConnectedCountLimit = -3003,
